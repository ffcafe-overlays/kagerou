...
;(function () {
  ...
  class HistoryUI {
    ...
    updateList() {
      ...
      r.reverse()
      if (r.length !== 0) r.map((_) => dom.appendChild(_))
    }
  ...
  window.addEventListener('load', () => {
    ...
    if (
      navigator.userAgent.indexOf('Overlay') !== -1 ||
